...
import quantumerp
from quantumerp.accounts.report.item_wise_sales_register.item_wise_sales_register import (
	add_sub_total_row,
	add_total_row,
...
def _execute(filters=None, additional_table_columns=None):
	...
	company_currency = quantumerp.get_company_currency(filters.company)
