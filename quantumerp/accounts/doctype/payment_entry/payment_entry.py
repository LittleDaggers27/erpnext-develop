...
import quantumerp
from quantumerp.accounts.doctype.accounting_dimension.accounting_dimension import get_dimensions
from quantumerp.accounts.doctype.bank_account.bank_account import (
	get_bank_account_details,
	get_default_company_bank_account,
	get_party_bank_account,
)
from quantumerp.accounts.doctype.invoice_discounting.invoice_discounting import (
	get_party_account_based_on_invoice_discounting,
)
from quantumerp.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
...
from quantumerp.accounts.party import complete_contact_details, get_party_account, set_contact_details
...
from quantumerp.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.accounts.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from quantumerp.accounts.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from quantumerp.accounts.doctype.payment_entry_reference.payment_entry_reference import (
	...
	def update_payment_requests(self, cancel=False):
		from quantumerp.accounts.doctype.payment_request.payment_request import (
	...
	def build_gl_map(self):
		...
		company_currency = quantumerp.get_company_currency(self.company)
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or quantumerp.get_company_currency(ref_doc.company)
