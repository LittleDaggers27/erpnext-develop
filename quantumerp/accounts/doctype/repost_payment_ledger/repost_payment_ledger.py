...
from quantumerp.accounts.utils import _delete_pl_entries, create_payment_ledger_entry
...
class RepostPaymentLedger(Document):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.accounts.doctype.repost_payment_ledger_items.repost_payment_ledger_items import (
