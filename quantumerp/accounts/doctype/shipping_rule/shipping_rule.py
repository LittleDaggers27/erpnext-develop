...
class ShippingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.accounts.doctype.shipping_rule_condition.shipping_rule_condition import (
			ShippingRuleCondition,
		)
		from quantumerp.accounts.doctype.shipping_rule_country.shipping_rule_country import (
			ShippingRuleCountry,
		)
