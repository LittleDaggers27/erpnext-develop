...
from quantumerp.accounts.party import get_party_account_currency
from quantumerp.accounts.report.accounts_receivable.accounts_receivable import execute as get_ar_soa
from quantumerp.accounts.report.accounts_receivable_summary.accounts_receivable_summary import (
	execute as get_ageing,
)
from quantumerp.accounts.report.general_ledger.general_ledger import execute as get_soa
...
class ProcessStatementOfAccounts(Document):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.accounts.doctype.process_statement_of_accounts_cc.process_statement_of_accounts_cc import (
			ProcessStatementOfAccountsCC,
		)
		from quantumerp.accounts.doctype.process_statement_of_accounts_customer.process_statement_of_accounts_customer import (
			ProcessStatementOfAccountsCustomer,
		)
		from quantumerp.accounts.doctype.psoa_cost_center.psoa_cost_center import PSOACostCenter
		from quantumerp.accounts.doctype.psoa_project.psoa_project import PSOAProject
