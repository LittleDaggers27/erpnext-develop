...
def task(doc_name, from_doctype, to_doctype):
	from quantumerp.accounts.doctype.payment_entry import payment_entry
	from quantumerp.accounts.doctype.purchase_invoice import purchase_invoice
	from quantumerp.accounts.doctype.sales_invoice import sales_invoice
	from quantumerp.buying.doctype.purchase_order import purchase_order
	from quantumerp.buying.doctype.supplier_quotation import supplier_quotation
	from quantumerp.selling.doctype.quotation import quotation
	from quantumerp.selling.doctype.sales_order import sales_order
	from quantumerp.stock.doctype.delivery_note import delivery_note
	from quantumerp.stock.doctype.purchase_receipt import purchase_receipt
