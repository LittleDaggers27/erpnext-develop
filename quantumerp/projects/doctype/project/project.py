...
from quantumerp import get_default_company
from quantumerp.controllers.queries import get_filters_cond
from quantumerp.controllers.website_list_for_contact import get_customers_suppliers
from quantumerp.setup.doctype.holiday_list.holiday_list import is_holiday
...
class Project(Document):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.projects.doctype.project_user.project_user import ProjectUser
