...
from quantumerp.stock.serial_batch_bundle import BatchNoValuation, SerialNoValuation
from quantumerp.stock.valuation import FIFOValuation, LIFOValuation
...
def get_incoming_rate(args, raise_error_if_no_rate=True):
	...
	from quantumerp.stock.stock_ledger import get_previous_sle, get_valuation_rate
	...
	if in_rate is None:
		...
		in_rate = get_valuation_rate(
			...
			currency=quantumerp.get_company_currency(args.get("company")),
