...
from quantumerp.stock.doctype.item_default.item_default import ItemDefault
...
class Item(Document):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.stock.doctype.item_barcode.item_barcode import ItemBarcode
		from quantumerp.stock.doctype.item_customer_detail.item_customer_detail import ItemCustomerDetail
		from quantumerp.stock.doctype.item_default.item_default import ItemDefault
		from quantumerp.stock.doctype.item_reorder.item_reorder import ItemReorder
		from quantumerp.stock.doctype.item_supplier.item_supplier import ItemSupplier
		from quantumerp.stock.doctype.item_tax.item_tax import ItemTax
		from quantumerp.stock.doctype.item_variant_attribute.item_variant_attribute import ItemVariantAttribute
		from quantumerp.stock.doctype.uom_conversion_detail.uom_conversion_detail import UOMConversionDetail
			...
			item_price = frappe.get_doc(
				{
					...
					"uom": self.stock_uom,
					"brand": self.brand,
					"currency": quantumerp.get_default_currency(),
	...
	def recalculate_bin_qty(self, new_name):
		from quantumerp.stock.stock_balance import repost_stock
...
def get_asset_naming_series():
	from quantumerp.assets.doctype.asset.asset import get_asset_naming_series
