...
from quantumerp.accounts.party import render_address
from quantumerp.controllers.accounts_controller import get_taxes_and_charges
from quantumerp.controllers.sales_and_purchase_return import get_rate_for_return
from quantumerp.controllers.stock_controller import StockController
from quantumerp.stock.doctype.item.item import set_item_default
from quantumerp.stock.get_item_details import get_bin_details, get_conversion_factor
from quantumerp.stock.utils import get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from quantumerp.accounts.party import _get_party_details
			...
			from quantumerp.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from quantumerp.controllers.buying_controller import validate_item_type
