...
from quantumerp.support.doctype.issue.issue import get_holidays
...
class ServiceLevelAgreement(Document):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.support.doctype.pause_sla_on_status.pause_sla_on_status import PauseSLAOnStatus
		from quantumerp.support.doctype.service_day.service_day import ServiceDay
		from quantumerp.support.doctype.service_level_priority.service_level_priority import (
			ServiceLevelPriority,
		)
		from quantumerp.support.doctype.sla_fulfilled_on_status.sla_fulfilled_on_status import (
