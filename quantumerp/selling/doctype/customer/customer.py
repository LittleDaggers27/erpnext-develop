...
from quantumerp.accounts.party import get_dashboard_info, validate_party_accounts
from quantumerp.controllers.website_list_for_contact import add_role_for_portal_user
...
class Customer(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.accounts.doctype.allowed_to_transact_with.allowed_to_transact_with import (
			AllowedToTransactWith,
		)
		from quantumerp.accounts.doctype.party_account.party_account import PartyAccount
		from quantumerp.selling.doctype.customer_credit_limit.customer_credit_limit import (
			CustomerCreditLimit,
		)
		from quantumerp.selling.doctype.sales_team.sales_team import SalesTeam
		from quantumerp.utilities.doctype.portal_user.portal_user import PortalUser
	...
	def copy_communication(self):
		...
		from quantumerp.crm.utils import copy_comments, link_communications
