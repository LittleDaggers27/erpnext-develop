...
from quantumerp.accounts.utils import get_balance_on, get_count_on, get_fiscal_year
...
class EmailDigest(Document):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.setup.doctype.email_digest_recipient.email_digest_recipient import (
	...
	def get_msg_html(self):
		...
		from quantumerp.setup.doctype.email_digest.quotes import get_random_quote
