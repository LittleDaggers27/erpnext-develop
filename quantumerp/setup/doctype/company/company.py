...
from quantumerp.setup.setup_wizard.operations.taxes_setup import setup_taxes_and_charges
...
class Company(NestedSet):
	...
	def create_default_accounts(self):
		from quantumerp.accounts.doctype.account.chart_of_accounts.chart_of_accounts import create_charts
...
def create_transaction_deletion_request(company):
	from quantumerp.setup.doctype.transaction_deletion_record.transaction_deletion_record import (
