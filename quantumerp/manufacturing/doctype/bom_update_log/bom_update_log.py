...
from quantumerp.manufacturing.doctype.bom_update_log.bom_updation_utils import (
	get_leaf_boms,
...
class BOMUpdateLog(Document):
	...
	if TYPE_CHECKING:
		...
		from quantumerp.manufacturing.doctype.bom_update_batch.bom_update_batch import BOMUpdateBatch
